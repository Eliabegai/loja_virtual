...
@Entity
@Table(name = "vp_cp_loja_virt")
@SequenceGenerator(name = "seq_vp_cp_loja_virt", sequenceName = "seq_vp_cp_loja_virt", allocationSize = 1, initialValue = 1)
public class VendaCompraLojaVirtual implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_vp_cp_loja_virt")
	private Long id;
